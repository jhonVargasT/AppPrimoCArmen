...
<div id="response">
    ...
    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
        ...
        <div class="panel-body">
            ...
            <br>
            <br>
            <form method="POST" name="form-wizard" class="form-control-with-bg" id="idFormPromocion">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        ...
                                        <div class="form-group row m-b-10">
                                            <input type="hidden" value="{{$promocion->idPromocion}}" id="idPromocion">
                                            <label class="col-md-3 col-sm-3 col-form-label">Abreviatura de promocion:</label>
                                            <div class="col-md-4 col-sm-4">
                                                <input class="form-control" type="text" id="nombre" name="nombre" value="{{$promocion->nombre}}"
                                        ...
                                        <div class="form-group row m-b-10">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                               <textarea class="form-control" type="text" id="descripcion" name="descripcion"
                                                         data-parsley-group="step-1" data-parsley-required="true">{{$promocion->descripcion}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row m-b-10">
                                            ...
                                            <div class="col-md-2 col-sm-2">
                                                <input class="form-control" type="number" id="podesc" name="podesc" value="{{$promocion->descuento}}"
                                        ...
                                        <div class="form-group row m-b-10">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <input type="text" class="form-control" id="datepicker-autoClose" value="{{$promocion->fechaVigencia}}"
